...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bower_components/bower_package/css/notification.css') }}">
</head>
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <script src="{{ asset('bower_components/bower_package/js/pusher.min.js') }}"></script>
    ...
    <script src="{{ asset('bower_components/bower_package/js/adminPusher.js') }}"></script>
